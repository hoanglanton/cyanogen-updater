...
//	private long mRemainingTime;
	...
	public void switchToUpdateChooserLayout(List<UpdateInfo> availableUpdates)
	{
		...
		//Set the right wallpaper
		ScrollView s1 = (ScrollView) findViewById(R.id.ScrollUpdateDownloader);
		ScrollView s2 = (ScrollView) findViewById(R.id.ScrollApplyExisting);
		int Orientation = res.getConfiguration().orientation;
		if(Orientation == Configuration.ORIENTATION_LANDSCAPE)
		{
			s1.setBackgroundDrawable(res.getDrawable(R.drawable.background_landscape));
			s2.setBackgroundDrawable(res.getDrawable(R.drawable.background_landscape));
		}
		else if(Orientation == Configuration.ORIENTATION_PORTRAIT)
		{
			s1.setBackgroundDrawable(res.getDrawable(R.drawable.background));
